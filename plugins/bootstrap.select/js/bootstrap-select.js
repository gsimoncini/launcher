...
(function($) {
    ...
    Selectpicker.prototype = {
        ...
        createDropdown: function() {
            ...
            var searchbox = this.options.liveSearch ? '<div class="input-group input-group-sm  bs-searchbox"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input  type="text" class="input-search-dropdown input-block-level form-control" autocomplete="off"  placeholder="Buscar"></div>' /*'<div class="bs-searchbox"><input type="text" class="input-block-level form-control" autocomplete="off" /></div>'*/ : '';
